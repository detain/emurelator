...
class CleanCommand extends Command {
	...
	public function execute() {
        ...
        $newHistory = [];
        $badLines = [
            '/root/cpaneldirect/emurelator.phar vnc rebuild',
            '/root/cpaneldirect/emurelator.phar cron host-info',        
        ];
        ...
        file_put_contents($_SERVER['HOME'].'/.emurelator/history.json', json_encode($newHistory, JSON_PRETTY_PRINT));
	}
}
